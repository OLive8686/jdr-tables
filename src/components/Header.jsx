...
import { Dice6, RefreshCw, Archive, CalendarDays, List, LogOut, Plus, BookPlus } from 'lucide-react';
...
const Header = ({
  ...
  const { currentUser, isGM, logout } = useAuth();
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Connecté en tant que <span className="font-medium">{currentUser}</span>
                {isGM && <span className="ml-2 text-purple-600 font-medium">(MJ)</span>}
              </p>
            </div>
          </div>
